...
# TF record data
DATADIR="/mnt/nfs/users/piwatcha/my-tensorflow/data/cifar-10"
...
BATCH_SIZE=$my_b
LEARNING_RATE=
# LEARNING_RATE_SCHEDULE="0.1;80;0.01;120;0.001" # LR0;E1;LR1;...;En;LRn
LEARNING_RATE_SCHEDULE=${my_s}
...
# Run.
#
python tf_cnn_benchmarks.py $FLAGS # > results/v13/b-${my_b}-g-${my_g}-r-${my_r}-ps.out 2>&1
