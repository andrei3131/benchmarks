...
CHECKPOINT_DIRECTORY="/data/kungfu/checkpoints/andrei-checkpoints/kungfu-logs-validation/checkpoints-replicated-correct"
...
python3 tf_cnn_benchmarks.py $FLAGS # > /resnet-32-b-$B-g-$G-replicated-correct.out 2>&1
