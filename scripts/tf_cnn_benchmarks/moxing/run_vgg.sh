...
#TONIGHT
python tf_cnn_benchmarks.py --model=vgg16 \
    --data_name=imagenet \
...
python tf_cnn_benchmarks.py --eval=True --forward_only=False --model=vgg16 --data_name=imagenet --data_dir=/cache/data_dir \
